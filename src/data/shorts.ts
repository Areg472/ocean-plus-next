...
export const shorts: Short[] = [
    {
        ...
        creator: "Carlo Bear",
        shortLink: process.env.VITE_SHORT_LINK_CARLOS_BIRTHDAY_GONE_WRONG,
    ...
    },
    {
        ...
        creator: "Carlo Bear",
        shortLink: process.env.VITE_SHORT_LINK_MASKMAS,
        url: "/Maskmas",
    ...
    },
    {
        ...
        creator: "Carlo Bear",
        shortLink: process.env.VITE_SHORT_LINK_TURKEY,
        url: "/New-Turkey-Eve",
        functionName: "Turkey",
    },
    {
        ...
        shortLink: process.env.VITE_SHORT_LINK_STEAMBOAT_WILLIE,
    ...
    },
    {
        ...
        creator: "Carlo Bear",
        shortLink: process.env.VITE_SHORT_LINK_BLA_BLA,
